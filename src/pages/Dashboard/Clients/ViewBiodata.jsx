            ...
            {singleBiodata?.biodataId ? (
              <>
                <div>
                  ...
                  <h1 className="font-medium text-xl py-2 border-b border-primary-normal text-center">
                    <span className="font-bold">ID: </span> #0
                    {singleBiodata?.biodataId}
                  </h1>

                  <p className="py-2 flex justify-between border-b pt-3">
                    <span className="font-medium">Age :</span>{" "}
                    {singleBiodata?.age}
                  </p>
                  <p className="py-2 flex justify-between border-b">
                  ...
                  <p className="py-2 flex justify-between border-b">
                    ...
                    {singleBiodata?.height}ft {singleBiodata?.inches}in
                  </p>
                  <p className="py-2 flex justify-between border-b">
                  ...
                  <p className="py-2 flex justify-between border-b">
                    ...
                    {singleBiodata?.expectedPartnerAge}
                  </p>
                  <p className="py-2 flex justify-between border-b">
                    <span className="font-medium">
                      Expected Partner Height :
                    </span>{" "}
                    {singleBiodata?.expectedPartnerHeight}ft{" "}
                    {singleBiodata?.expectedPartnerInches}in
                  </p>
                  <p className="py-2 flex justify-between border-b">
                    <span className="font-medium">Expected Partner Age :</span>{" "}
                    {singleBiodata?.expectedPartnerAge}
                  ...
                  <p className="py-2 flex justify-between">
                    ...
                    {singleBiodata?.expectedPartnerWeight}
                  </p>
                  ...
                  {selfUser?.isPro === "Pending" &&
                  selfBiodata?.isPro === "Pending" ? (
                    <>
                      <button className="py-2 px-3 text-base mt-10 rounded bg-gray-400 text-white">
                    ...
                    <>
                      ...
                      selfBiodata?.isPro === "Premium" ? (
                        <>
                          <button className="py-2 px-3 text-base mt-10 rounded bg-sky-500 text-white">
                        ...
                        <>
                          <button
                            onClick={handleRequestForPro}
                            className="py-2 px-3 text-base mt-10 rounded bg-primary-normal text-white"
                          >
