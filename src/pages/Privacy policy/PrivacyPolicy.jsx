      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 pb-9 py-9 px-4 privacy-policy">
        <div className="flex flex-col lg:flex-row justify-between gap-8">
            ...
            <div className="translations-content-container">
              <div className="container">
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        ...
                        to लाडशखीय वाणी समाज मंडळ समन्वय समिती मुंबई, Thane,
                        400601.
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>
                        <strong>Website</strong> refers to लाडशखीय वाणी समाज
                        मंडळ समन्वय समिती, मुंबई आणि संस्कारवाणी&nbsp;मुंबई,
                        accessible from{" "}
                        <a
                          href="https://samanvaysamiti.com"
                          rel="external nofollow noopener"
                          target="_blank"
                        >
                          https://samanvaysamiti.com{" "}
                        </a>
                      </p>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      <p>By email: contact@samanvaysamiti.com</p>
                    </li>
                    <li>
                      <p>
          ...
          {/* <div className="w-full flex flex-col justify-center">
            ...
            <h5>Last updated: December 16, 2023</h5>
            ...
            <h1 className="text-xl mt-10 lg:text-2xl font-bold leading-9 text-gray-800 pb-2">
              Interpretation and Definitions
            </h1>
            <h1 className="text-md mt-10 lg:text-xl font-bold leading-9 text-gray-800 pb-4">
              Interpretation
            </h1>
            ...
            <p className="font-normal text-base leading-6 text-dark-600 ">
              For the purposes of this Privacy Policy:
              <br />
              <br />• <span className="font-bold">Account</span> means a unique
              account created for You to access our Service or parts of our
              Service.
              <br />
              <br />• <span className="font-bold"> Affiliate</span> means an
              ...
              <br /> <br />• <span className="font-bold"> Company </span>
              (referred to as either "the Company", "We", "Us" or "Our" in this
              Agreement) refers to लाडशखीय वाणी समाज मंडळ समन्वय समिती मुंबई,
              Thane, 400601.
              <br /> <br />• <span className="font-bold">Cookies</span> are
              ...
              <br />
              <br />• <span className="font-bold"> Country </span>refers to:
              Maharashtra, India
              <br />
              <br />• <span className="font-bold">Device</span> means any device
              that can access the Service such as a computer, a cellphone or a
              digital tablet.
              <br /> <br />• <span className="font-bold">Personal Data</span> is
              any information that relates to an identified or identifiable
              individual.
              <br />
              <br />• <span className="font-bold"> Service </span>refers to the
              Website.
              <br />
              <br />• <span className="font-bold"> Service Provider</span> means
              ...
              <br />
              <br />• <span className="font-bold"> Usage Data</span> refers to
              ...
              <br />
              <br />• <span className="font-bold"> Website </span>refers to
              लाडशखीय वाणी समाज मंडळ समन्वय समिती, मुंबई आणि संस्कारवाणी मुंबई,
              accessible from https://samanvaysamiti.com <br />
              <br />• <span className="font-bold">You</span> means the
            ...
            <h1 className="text-md mt-10 lg:text-xl font-bold leading-9 text-gray-800 pb-2">
