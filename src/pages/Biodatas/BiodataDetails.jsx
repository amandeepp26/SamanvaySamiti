...
const BiodataDetails = () => {
  ...
  return (
    <div className="container mx-auto px-5 grid lg:gap-3">
      <div className="border-b-2 lg:border-b-0 lg:border-r bg-[#ffffffc2] pb-8">
        <div className="p-2">
          <div className="w-48 relative mt-5 float-right">
            <img
              className="w-full"
          ...
          <h1 className="font-medium text-xl py-2 border-b border-primary-normal text-center">
            <span className="font-bold">ID: </span> #0{singleBiodata?.biodataId}
          </h1>
          ...
          <div>
            ...
            <p className="py-1">
              <span className="font-medium">Race :</span> {singleBiodata?.race}
            </p>
            <p className="py-1">
